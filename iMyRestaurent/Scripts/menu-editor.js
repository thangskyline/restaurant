...
var handler = {
        ...
        open: function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    var html = '';
                    html += '<div id="border-dialog" class="popup-dialog lv4 detail-dialog">';
                    html += '   <div id="setting-dialog" style="background: #f2d5c7;-webkit-border-radius: 10px;">';
                    html += '       <div class="header-setting">';
                    html += '           <div style="float:right;" >';
                    html += '               <a id="btn-setting-close" href="#" class="classic-popup-close" title="Close">';
                    html += '                   <img src="/Content/images/details-close-btn.png" width="21" height="21">';
                    html += '               </a>';
                    html += '           </div>'
                    html += '           <div class="title">Common Menu Settings for Locations</div>';
                    html += '       </div>';
                    html += '       <div class="body-setting">';
                    html += '           <table class="setting" border="0" cellpadding="0">';
                    html += '               <tbody>';
                    html += '                   <tr class="header">';
                    html += '                       <td class="location-name" width="380">Location Name</td>';
                    html += '                       <td width="100">Block Order</td>';
                    html += '                       <td width="100">Deliverable</td>';
                    html += '                       <td width="140">Delivery Zone(km)</td>';
                    html += '                       <td width="auto">Pick up</td>';
                    html += '                   </tr>';
                    html += '                   <tr class="first">';
                    html += '                       <td class="location-name">All</td>';
                    html += '                       <td><input to="block-order" id="all-block-order" type="checkbox"></td>';
                    html += '                       <td><input to="delivable" id="all-delivable" type="checkbox"></td>';
                    html += '                       <td><input class="delivery-zone" id="all-delivery-zone" type="text"></td>';
                    html += '                       <td class="left-cell"><input to="pick-up" id="all-pick-up" type="checkbox"></td>';
                    html += '                   </tr>';
                    html += '               </tbody>';
                    html += '           </table>';
                    html += '           <div id="scrollable-div">';
                    html += '               <table id="table-setting" class="setting" border="0" cellpadding="0">';
                    html += '                   <tbody>';
                    if (response.Locations != null) {
                        for (var i = 0; i < response.Locations.length; i++) {
                            ...
                            html += '                   <td class="location-name" width="380">' + locationName + '</td>';
                            html += '                   <td width="100"><input for="block-order" ' + isBlockOrder + ' type="checkbox"></td>';
                            html += '                   <td width="100"><input for="delivable" ' + isDelivable + ' type="checkbox"></td>';
                            html += '                   <td width="140"><input for="delivery-zone" class="delivery-zone" value="' + deliveryZone.toFixed(2) + '" type="text"></td>';
                            html += '                   <td width="auto" class="left-cell"><input for="pick-up" ' + isPickup + ' type="checkbox"></td>';
                            html += '               </tr>';
                        }
                    }
                    html += '                   </tbody>';
                    ...
                    $('#border-dialog').css({ top: 0, left: 0 });
                    FlexibleLayout.adapt();
                    Utils.positioningDialog('#border-dialog', 'center', 'center');

                    $('.body-setting').height($('#border-dialog').height() - 35);
    ...
    common: function () {
        ...
        $('#all-delivery-zone').live('keypress', function () {
            setTimeout(function () {
                var fValue = parseFloat($('#all-delivery-zone').val());
                $('.delivery-zone').not('#all-delivery-zone').val(fValue.toFixed(2));
            }, 100);
        })
    ...
    add: function () {
        // add menu
        $('#btn-menu-add').click(editor.controller.menu.add);

        $("#btn-sec-add").click(editor.controller.section.add);

        $('#btn-subsec-add').click(editor.controller.subsection.add);

        $("#btn-item-add").click(editor.controller.item.add);

        $('#btn-group-add').click(editor.controller.group.add);

        $("#btn-option-add").click(editor.controller.option.add);
    },
    save: function () {
                            ...
                            if (editor.global.menu != null) {
                                ...
                                if (editor.global.menu.Sections != null) {
                                    ...
                                    for (var i = 0; i < editor.global.menu.Sections.length; i++) {
                                        ...
                                        $("#drop-sec").append('<li><a value="' + section.SectionID + '" href="#">' + displaySectionName + '</a></li>');
                                    }
                                }
        ...
        section: {
            ...
            get: function () {
                ...
                if (editor.global.section.SubSections != null) {
                    ...
                    for (var i = 0; i < editor.global.section.SubSections.length; i++) {
                        ...
                        $('#drop-subsec').append('<li><a value="' + subsection.SectionID + '" href="#">' + displaySubSectionName + '</a></li>');
                ...
                if (editor.global.section.Items != null) {
                    ...
                    for (var i = 0; i < editor.global.section.Items.length; i++) {
                        ...
                        $('#drop-item').append('<li><a value="' + item.ItemID + '" href="#">' + displayItemName + '</a></li>');
                    }
                }
            ...
            del: function () {
                ...
                if ($("#drop-sec").find('.selected').length != 0) {
                    ...
                    MessageBox.show({
                        message: ['Please choose a Section to delete!'],
                        buttons: {
                            ok: null
                        }
                    });
        ...
        subsection: {
            ...
            del: function () {
                ...
                if ($("#drop-subsec").find('.selected').length != 0) {
                    ...
                    MessageBox.show({
                        message: ['Please choose a Sub Section to delete!'],
                        buttons: {
                            ok: null
                        }
                    });
        ...
        item: {
            ...
            get: function () {
                ...
                if (editor.global.item.Groups != null) {
                    ...
                    for (var i = 0; i < editor.global.item.Groups.length; i++) {
                        ...
                        $('#drop-group').append('<li><a value="' + group.GroupID + '" href="#">' + displayGroupName + '</a></li>');
                    }
                }
            ...
            del: function () {
                ...
                if ($("#drop-item").find('.selected').length != 0) {
                    ...
                    MessageBox.show({
                        message: ['Please choose an Menu Item to delete!'],
                        buttons: {
                            ok: null
                        }
                    });
        ...
        group: {
            ...
            get: function () {
                ...
                if (editor.global.group.Options != null) {
                    ...
                    for (var i = 0; i < editor.global.group.Options.length; i++) {
                        ...
                        $('#drop-option').append('<li><a value="' + option.OptionID + '" href="#">' + displayOptionName + '</a></li>');
                    }
                }
            ...
            del: function () {
                ...
                if ($("#drop-group").find('.selected').length != 0) {
                    ...
                    MessageBox.show({
                        message: ['Please choose a Group to delete!'],
                        buttons: {
                            ok: null
                        }
                    });
            ...
            postSave: function (response) {
                ...
                if (response.IsSucceed) {
                    if (response.ActionType == 'add') {
                        ...
                        .attr('href', '#')
                        .html(displayGroupName);

                        $('#drop-group').append($('<li />').append(anchor));
        ...
        option: {
            ...
            del: function () {
                ...
                if ($("#drop-option").find('.selected').length != 0) {
                    ...
                    MessageBox.show({
                        message: ['Please choose a Option to delete!'],
                        buttons: {
                            ok: null
                        }
                    });
            ...
            postSave: function (response) {
                ...
                if (response.IsSucceed) {
                    if (response.ActionType == 'add') {
                        ...
                        .attr('href', '#')
                        .html(displayOptionName);

                        $('#drop-option').append($('<li />').append(anchor));
